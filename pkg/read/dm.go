...
func init() {
	...
	// List flags
	dmListCmd.Flags().Int("limit", 50, "Maximum number of DM conversations to return (default: 50, sorted by last activity)")
	...
	dmHistoryCmd.Flags().Int("limit", 20, "Maximum number of messages (default: 20)")
}
